...
- **Deliverable:**
  ...
  - `docs/adr/ADR-001-pg-tenant-isolation.md` -- architecture decision record
...
- **Deliverable:**
  ...
  - `docs/adr/ADR-002-redis-streams-queue.md` -- architecture decision record
...
- **Deliverable:**
  ...
  - `docs/adr/ADR-003-go-workspace-composition.md` -- documents MVS behavior, conflict policy, replace strategy
  - `docs/adr/ADR-005-cobra-cli-extension.md` -- documents init() vs constructor pattern, recommendation
...
- **Deliverable:**
  ...
  - `docs/adr/ADR-006-meilisearch-tenant-isolation.md` -- architecture decision record with recommended isolation pattern
