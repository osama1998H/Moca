...
| `docs/adr/ADR-002-redis-streams-queue.md` | Full | — | Validated: consumer groups, DLQ, delayed jobs |
| `docs/adr/ADR-006-meilisearch-tenant-isolation.md` | Full | — | Validated: index-per-tenant, bulk indexing |
...
- **Inputs / References:**
  ...
  - `docs/adr/ADR-002-redis-streams-queue.md` — architectural decisions
...
- **Inputs / References:**
  ...
  - `docs/adr/ADR-006-meilisearch-tenant-isolation.md` — index-per-tenant decisions
