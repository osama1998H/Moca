...
func buildDocTypeMetaType() *meta.MetaType {
	return &meta.MetaType{
		...
		Fields: []meta.FieldDef{
			{Name: "dt_module", FieldType: meta.FieldTypeData, Label: "Module", InListView: true, InAPI: true},
			{Name: "dt_label", FieldType: meta.FieldTypeData, Label: "Label", InAPI: true},
			{Name: "dt_description", FieldType: meta.FieldTypeText, Label: "Description", InAPI: true},
			{Name: "fields", FieldType: meta.FieldTypeTable, Label: "Fields", Options: "DocField", InAPI: true},
			{Name: "permissions", FieldType: meta.FieldTypeTable, Label: "Permissions", Options: "DocPerm", InAPI: true},
			{Name: "is_submittable", FieldType: meta.FieldTypeCheck, Label: "Is Submittable", InAPI: true},
			{Name: "is_single", FieldType: meta.FieldTypeCheck, Label: "Is Single", InAPI: true},
			{Name: "is_child_table", FieldType: meta.FieldTypeCheck, Label: "Is Child Table", InAPI: true},
			{Name: "is_virtual", FieldType: meta.FieldTypeCheck, Label: "Is Virtual", InAPI: true},
			{Name: "dt_track_changes", FieldType: meta.FieldTypeCheck, Label: "Track Changes", InAPI: true},
			{Name: "dt_naming_rule", FieldType: meta.FieldTypeData, Label: "Naming Rule", InAPI: true},
			{Name: "dt_title_field", FieldType: meta.FieldTypeData, Label: "Title Field", InAPI: true},
			{Name: "dt_sort_field", FieldType: meta.FieldTypeData, Label: "Sort Field", InAPI: true},
			{Name: "dt_sort_order", FieldType: meta.FieldTypeSelect, Label: "Sort Order", Options: "asc\ndesc", InAPI: true},
			{Name: "dt_search_fields", FieldType: meta.FieldTypeData, Label: "Search Fields", InAPI: true},
			{Name: "dt_image_field", FieldType: meta.FieldTypeData, Label: "Image Field", InAPI: true},
		},
